...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YBWebViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/YBWebViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chason' => 'qoakzmxncb@qq.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/YBWebViewController.git', :tag => s.version.to_s }
